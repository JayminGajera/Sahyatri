  ...
  return (
    <div className="flex md:bg-black flex-col justify-between md:w-1/3 md:mx-auto text-white p-5 md:gap-y-4 gap-y-8">
      ...
      <div className="text-xl md:text-2xl p-2 md:p-0">
        ...
        <h2 className="opacity-65 text-sm md:text-xl">We’ll text you login code</h2>
      </div>
      <form onSubmit={handleSubmit} className="flex flex-col text-[0.9rem] mt-3 md:text-[1rem]">
